...
export function Courses() {
  ...
  const courses = [
    ...
    {
      title: "ABHYASA Meetings",
      image: "https://abhyasa.graphy.com/_next/image?url=https%3A%2F%2Fd502jbuhuh9wk.cloudfront.net%2Fcourses%2F66efec953d2dba4bb1c40a2b%2Fcover%2F2024-09-22T10%3A09%3A25.295Z.jpg&w=828&q=75",
      modules: 1,
      language: "English",
      access: "LifeTime",
      url: "https://abhyasa.graphy.com/courses/ABHYASA-Meetings-66efec953d2dba4bb1c40a2b",
      url2: "https://abhyasa.graphy.com/courses/ABHYASA-Meetings-66efec953d2dba4bb1c40a2b"
    ...
    <div className="min-h-screen  py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
        {courses.map((course, index) => (
          <Card key={index} className="bg-gray-800 border-gray-700 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_25px_5px_rgba(30,58,138,0.6)]
">
            <img
              src={course.image}
